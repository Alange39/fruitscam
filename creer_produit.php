...
<head>
    ...
    <title>Fruitscam/Creer_Produit</title>
</head>
<body>
    ...
    <div class="bg-white rounded-2xl shadow-md overflow-hidden p-8">
        ...
        <form class="flex flex-col p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <!-- Nom du produit -->
                <div class="mb-4 mr-4">
                    <label for="productName" class="block mb-2 font-bold">Nom du produit</label>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="format" name="format" placeholder="Ex: 250ml, 500ml, 1L..." required
                        class="w-full p-2 border border-gray-300 rounded-md">
                </div>
                <!-- Prix -->
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" placeholder="Entrez la description du produit" required
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="mainPhoto" class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 relative overflow-hidden">
                        ...
                        <input id="mainPhoto" type="file" class="hidden" accept="image/*" onchange="previewMainImage(this)" />
                    </label>
                </div>
            </div>
            ...
            <div class="flex justify-center mt-6">
                <button type="submit" class="bg-[#6A664B] text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 hover:text-[#45a049] w-full md:w-[200px]">Creer</button>
            </div>
        </form>
    </div>
</section>
