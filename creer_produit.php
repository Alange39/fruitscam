...
<body>
    ...
    <section class="w-4/5 max-w-[1200px] mx-auto p-8">
        <div class="bg-white rounded-2xl shadow-md overflow-hidden p-8">
            ...
            <form class="flex flex-col p-6" action="add_products.php" method="post" enctype="multipart/form-data">
                ...
                <div class="flex justify-center mt-6">
                    <button type="submit" name="sub" class="bg-[#6A664B] text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 hover:text-[#45a049] w-full md:w-[200px]">Creer</button>
                </div>
            </form>
        </div>
    </section>
